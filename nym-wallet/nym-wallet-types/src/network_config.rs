...
#[cfg_attr(
    feature = "generate-ts",
    ts(export_to = "nym-wallet/types/src/types/rust/ValidatorUrls.ts")
)]
...
#[cfg_attr(
    feature = "generate-ts",
    ts(export, export_to = "nym-wallet/types/rust/validatorurl.ts")
)]
#[derive(Debug, Serialize, Deserialize)]
...
#[cfg_attr(
    feature = "generate-ts",
    ts(export, export_to = "nym-wallet/types/rust/validatorurls.ts")
)]
#[derive(Debug, Serialize, Deserialize)]
